...
public:
    ...
    const glm::vec3 GetMaterialAmbient(unsigned int material_index) const
    {
        return glm::vec3(m_material[material_index].ambient.x, m_material[material_index].ambient.y, m_material[material_index].ambient.z);
    }

    const glm::vec3 GetMaterialDiffuse(unsigned int material_index) const
    {
        return glm::vec3(m_material[material_index].diffuse.x, m_material[material_index].diffuse.y, m_material[material_index].diffuse.z);
    }
